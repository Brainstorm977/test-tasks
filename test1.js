...
// Во-вторых - в задании сказано присвойть false тем объектам, у кого отсуствует свойство withOwner.
...
//     const animal = animals[i];
//     if (!animal.hasOwnProperty('withOwner')) animal.withOwner = false;
// }
// console.log(animals);
...
animals.forEach(animal => {
    if (!animal.hasOwnProperty('withOwner')) {
        animal.withOwner = false;
    }
})
...
var nobodysCatList = animals.filter(animal => animal.kind === 'cat' && !animal.withOwner && animal.age > 2);
console.log(nobodysCatList);